...
test_that("package_convert_int_literals skips generated RcppExports files", {
  root <- make_test_pkg()
  rcpp_exports <- file.path(root, "R", "RcppExports.R")
  regular_file <- file.path(root, "R", "regular.R")
  writeLines("// Generated by Rcpp::compileAttributes()", rcpp_exports)
  writeLines("f <- function() 1", regular_file)

  changed <- package_convert_int_literals(root)

  expect_equal(
    readLines(rcpp_exports, warn = FALSE),
    "// Generated by Rcpp::compileAttributes()"
  )
  expect_equal(readLines(regular_file, warn = FALSE), "f <- function() 1L")
  expect_equal(changed, norm(regular_file))
})
...
test_that("package_convert_int_literals processes explicitly selected tests/ files", {
  root <- make_test_pkg()
  writeLines("f <- function() 1", file.path(root, "R", "a.R"))
