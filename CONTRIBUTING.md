...
This outlines how to propose a change to rpkgkit. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("Exceret/rpkgkit", fork = TRUE)`.
...
Please note that the rpkgkit project is released with a [Contributor
Code of
Conduct](https://wanglabcsu.github.io/rpkgkit/CODE_OF_CONDUCT.md). By
