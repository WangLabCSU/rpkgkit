...
#> ✔ Converted function definitions in /tmp/RtmpcVtOJE/file1a83168d16a7.R to "to_lambda"
readLines(temp)
#> [1] "add_one <- \\(x) x + 1"
# "add_one <- \(x) x + 1"
convert_func_syntax(temp, direction = "to_explicit")
#> ✔ Converted function definitions in /tmp/RtmpcVtOJE/file1a83168d16a7.R to "to_explicit"
readLines(temp)
