...
#> ✔ Converted function definitions in /tmp/RtmpAM3FIu/file1b243cdb145a.R to "to_lambda"
readLines(temp)
#> [1] "add_one <- \\(x) x + 1"
# "add_one <- \(x) x + 1"
convert_func_syntax(temp, direction = "to_explicit")
#> ✔ Converted function definitions in /tmp/RtmpAM3FIu/file1b243cdb145a.R to "to_explicit"
readLines(temp)
