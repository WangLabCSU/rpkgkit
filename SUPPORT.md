...
Thanks for using rpkgkit! Before filing an issue, there are a few places
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/Exceret/rpkgkit/issues/new).
...
requests](https://github.com/Exceret/rpkgkit/issues) to make sure the
