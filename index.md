...
- [`inquire_standalone()`](https://wanglabcsu.github.io/rpkgkit/reference/inquire_standalone.md) -
  List standalone files available in a GitHub repository’s `R/`
  directory

- [`browse_standalone()`](https://wanglabcsu.github.io/rpkgkit/reference/browse_standalone.md) -
  Look up all available standalone files in GitHub repositories
...
- [`create_standalone()`](https://wanglabcsu.github.io/rpkgkit/reference/create_standalone.md) -
  Create standalone utility files in your package
...
- [`update_time_in_standalone()`](https://wanglabcsu.github.io/rpkgkit/reference/update_time_in_standalone.md) -
  Update `last-updated` field in standalone files
...
- [`news_md_add_entry()`](https://wanglabcsu.github.io/rpkgkit/reference/news_md.md) -
...
- [`news_md_check()`](https://wanglabcsu.github.io/rpkgkit/reference/news_md.md) -
  Validate NEWS.md format for CRAN compliance
